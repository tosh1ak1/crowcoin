...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s crowcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  crowcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded crowcoin transaction") + "\n" +
              "  crowcoin-tx [options] -create [commands]   " + _("Create hex-encoded crowcoin transaction") + "\n" +
              "\n";
