...
const char * const BITCOIN_CONF_FILENAME = "crowcoin.conf";
const char * const BITCOIN_PID_FILENAME = "crowcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Crowcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Crowcoin";
#else
    // Unix
    return pathRet / ".crowcoin";
#endif
#endif
}
