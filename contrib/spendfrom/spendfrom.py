...
def determine_db_dir():
    ...
    if platform.system() == "Darwin":
        return os.path.expanduser("~/Library/Application Support/Crowcoin/")
    elif platform.system() == "Windows":
        return os.path.join(os.environ['APPDATA'], "Crowcoin")
...
def connect_JSON(config):
    ...
    if not 'rpcport' in config:
        config['rpcport'] = 19631 if testnet else 9631
