...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 9630
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 19631
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 19630
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 9630
	%{_sbindir}/semanage port -d -p tcp 19631
	%{_sbindir}/semanage port -d -p tcp 19630
	for selinuxvariant in %{selinux_variants}; do
