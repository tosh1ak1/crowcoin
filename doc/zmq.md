...
The Crowcoin Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Crowcoin Core requires ZeroMQ API version 4.x or
...
using. Crowcoind appends an up-counting sequence number to each
