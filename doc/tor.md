...
It is possible to run Crowcoin as a Tor hidden service, and connect to such services.
...
The first step is running Crowcoin behind a Tor proxy. This will already make all
...
your litecoind's P2P listen port (9630 by default).
...
Crowcoin Core automatically creates a hidden service to listen on. This will positively 
affect the number of available .onion nodes.

This new feature is enabled by default if Crowcoin Core is listening (`-listen`), and
