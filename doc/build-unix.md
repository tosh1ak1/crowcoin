UNIX BUILD NOTES
====================
Some notes on how to build Crowcoin Core in Unix.
...
memory available when compiling Crowcoin Core. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Crowcoin Core without wallet.
...
If you want to build Crowcoin-Qt, make sure that the required packages for Qt development
...
# Configure Crowcoin Core to use our own-built instance of BDB
cd $LITECOIN_ROOT
./autogen.sh
...
As mentioned above, when maintaining portability of the wallet between the standard Crowcoin Core distributions and independently built
...
with 4.8-built Crowcoin Core is needed follow the steps under "Berkeley DB" above.
