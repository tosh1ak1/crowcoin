...
*Setup instructions for a Gitian build of Crowcoin Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Crowcoin
...
- [Building Crowcoin Core](#building-litecoin-core)
...
To build Crowcoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
